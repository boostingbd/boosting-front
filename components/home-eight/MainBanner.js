          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="agency-banner-content">
                ...
                <p>
                  We provide Design Development and Digital Marketing Services
                  For SME business owners. Our first Priority provides Best
            ...
            <div className="col-lg-6 col-md-12">
              <div className="agency-banner-image">
                <img
                  src={require("../../static/images/agency-image/agency-banner-img2.jpg")}
                  alt="image"
                />
              </div>
            </div>
